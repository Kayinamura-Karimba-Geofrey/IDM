...
<a target="_top" href="default.asp">AppML HOME</a>
<a target="_top" href="appml_howto.asp">AppML How To</a>
<a target="_top" href="appml_data.asp">AppML Data</a>
<a target="_top" href="appml_includes.asp">AppML Includes</a>
<a target="_top" href="appml_controllers.asp">AppML Controllers</a>
<a target="_top" href="appml_messages.asp">AppML Messages</a>
<a target="_top" href="appml_models.asp">AppML Models</a>
<a target="_top" href="appml_methods.asp" class="not-wired">AppML API</a>
<br>
<h2 class="left"><span class="left_h2">AppML Cases</span></h2>
<a target="_top" href="appml_cases.asp">Case Intro</a>
<a target="_top" href="appml_case_txt.asp">Case Text File</a>
<a target="_top" href="appml_case_xml.asp">Case XML File</a>
<a target="_top" href="appml_case_json.asp">Case JSON File</a>
<a target="_top" href="appml_case_customers.asp">Case Customers</a>
<a target="_top" href="appml_case_products.asp">Case Products</a>
<a target="_top" href="appml_case_suppliers.asp">Case Suppliers</a>
<a target="_top" href="appml_case_shippers.asp">Case Shippers</a>
<a target="_top" href="appml_case_categories.asp">Case Categories</a>
<a target="_top" href="appml_case_employees.asp" class="not-wired">Case Employees</a>
<br>
<h2 class="left"><span class="left_h2">AppML Client</span></h2>
<a target="_top" href="appml_client.asp">AppML Client</a>
<a target="_top" href="appml_prototype.asp">AppML Prototype</a>
<a target="_top" href="appml_lists.asp">AppML Lists</a>
<a target="_top" href="appml_forms.asp">AppML Forms</a>
<a target="_top" href="appml_database.asp" class="not-wired">AppML WebSQL</a>
<br>
<h2 class="left"><span class="left_h2">AppML Server</span></h2>
<a target="_top" href="appml_php.asp">AppML PHP</a>
<a target="_top" href="appml_dotnet.asp" class="not-wired">AppML ASP</a>
<br>
<h2 class="left"><span class="left_h2">AppML Cloud</span></h2>
<a target="_top" href="appml_google_cloud_sql.asp">Google Cloud SQL</a>
<a target="_top" href="appml_amazon_rds.asp" class="not-wired">Amazon RDS SQL</a>
<br>
<h2 class="left"><span class="left_h2">AppML</span> Reference</h2>
<a target="_top" href="appml_reference.asp">AppML Reference</a>
<a target="_top" href="appml_ref_files.asp">AppML Datafiles</a>
<a target="_top" href="appml_ref_databases.asp">AppML Databases</a>
<a target="_top" href="appml_ref_api.asp">AppML API</a>
<a target="_top" href="appml_architecture.asp">AppML Architecture</a>
<a target="_top" href="appml_history.asp" class="not-wired">AppML History</a>
...
<a class="w3-left w3-btn ws-green" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn ws-green" href="appml_howto.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info w3-center">
<p style="font-size:35px">AppML Brings Data to HTML</p>
<p style="font-size:25px">"No Nonsense Web Applications"</p>
</div>


<hr>
<h2>Introduction</h2>
<p>The Web is growing fast, and the amount of data in Cyberspace is growing even faster.</p>
<p>Every day new information systems are developed, and every day new users are connected,
and data can be accessed 24/7 from anywhere in the world.</p>

<p class="w3-large"><i>Faster and better software development methods are desperately needed</i>.</p>

<p>Along these lines, W3Schools has developed a very flexible technique for retrieving, displaying, and manipulate data,
without the need for traditional programming.</p>

<p>Cooperating with Jan Egil Refsnes, W3schools has developed a vocabulary for defining Web applications.
The vocabulary is called AppML (Application Modeling Language).</p>

<p>AppML uses the most up-to-date techniques and ideas of modern Web development with focus on:</p>
<ul type="square">
  <li>Low Cost</li>
  <li>Rapid and Agile Web Develoment</li>
  <li>Optimized for Cloud Computing</li>
  <li>High Speed and Low Bandwidth Consumption</li>
...
<p>AppML supports the functions you find in other frameworks like
React, Angular, and Vue, but AppML is much easier to use, and much easier to understand.</p>

<hr>
<h2>What is AppML?</h2>
<p>AppML stands for <strong>App</strong>lication <strong>M</strong>odeling 
<strong>L</strong>anguage.</p>
<p>AppML is not a programming language. It is descriptive language (a language for describing applications).</p>
<p>It is built around familiar Web application concepts like:</p>
<ul>
<li>Forms</li>
<li>Lists</li>
<li>Reports</li>
...
<p>AppML runs in any HTML page. No installation is required. </p>
<p>AppML is a tool for bringing data to HTML applications:</p>

<ul>
  <li>From Objects</li>
  <li>From JSON files</li>
  <li>From Text files</li>
  <li>From XML files</li>
  <li>From databases</li>
</ul>

<p>
<a class="ws-btn" href="tryit.asp?filename=tryappml_from_object" target="_blank">Objects</a>
<a class="ws-btn" href="tryit.asp?filename=tryappml_from_json" target="_blank">JSON Files</a><br><br>
<a class="ws-btn" href="tryit.asp?filename=tryappml_from_txt" target="_blank">Text Files</a>
<a class="ws-btn" href="tryit.asp?filename=tryappml_from_xml" target="_blank">XML Files</a><br><br>
<a class="ws-btn" href="tryit.asp?filename=tryappml_customerslist_php" target="_blank">PHP/MySQL</a>
<!--<a class="ws-btn" href="tryit.asp?filename=tryappml_customerslist_aspx" target="_blank">ASP.NET/SQL</a>-->
</p>
...
<p>HTML is not very suitable for describing web applications.</p>
<p>AppML is made for web applications:</p>
<ul>
 <li>AppML extends HTML with data <strong>attributes.</strong></li>
 <li>AppML adds <strong>controllers</strong> to HTML, to control the behavior of 
HTML data.</li>
</ul>
<p>AppML is very easy to understand and extraordinarily quick to develop.</p>

<hr>

<h2>AppML Example</h2>

<p>This example shows how easy AppML can bring data to HTML: </p>
...
&lt;script src="https://www.w3schools.com/appml/2.0.3/appml.js"&gt;&lt;/script&gt;<br><br>
&lt;body&gt;<br>
&lt;h1&gt;Customers&lt;/h1&gt;<br><br>
&lt;table appml-data="customers.js"&gt;<br>
&lt;tr&gt;<br>&nbsp; &lt;th&gt;Customer&lt;/th&gt;<br>
&nbsp; &lt;th&gt;City&lt;/th&gt;<br>
&nbsp; &lt;th&gt;Country&lt;/th&gt;<br>
&lt;/tr&gt;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryappml_intro" target="_blank">Try It Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>AppML is a tool for easy, rapid, and agile web application development.</p>
</div>
<hr>

<h2>Easy and Agile</h2>

<p>On today's market, there are many frameworks (tools or libraries) designed to 
extend HTML.</p>
<p>Most of these frameworks manipulate HTML, CSS or JavaScript in a way that 
makes them difficult to use (especially when used in combination).</p>
<p>AppML is different. You have 
full HTML, CSS, and JavaScript freedom.</p>

<p>AppML makes it easy to create Single Page Applications (SPA) in a very clean 
and efficient way. </p>

<p>Even if you have never worked with web development before, you will find AppML 
very easy to use.</p>
<p>If you are an experienced web developer, you will soon discover 
the power of AppML.</p>
