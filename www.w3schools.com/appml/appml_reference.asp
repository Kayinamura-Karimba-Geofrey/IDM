...
<h1>App<span class="color_h1">ML</span> Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn ws-green" href="appml_amazon_rds.asp">&#10094; Previous</a>
<a class="w3-right w3-btn ws-green" href="appml_ref_files.asp">Next &#10095;</a>
</div>
<hr>
<h2>AppML HTML Attributes</h2>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
    &lt;div appml-include-html="inc_header.htm"&gt;&lt;/div&gt;<br><br>&lt;h1&gt;Customers&lt;/h1&gt;<br>&lt;table 
    appml-data="customers.js" appml-controller="myController"&gt;<br>&nbsp; &lt;tr&gt;<br>&nbsp;&nbsp;&nbsp; 
    &lt;th&gt;Customer&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;City&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; 
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryappml_ref_attributes" target="_blank">Try It Yourself &raquo;</a>
</div>
<table class="ws-table-all notranslate">
  <tr>
    <th width="25%">Attribute</th>
    <th>Description</th>
    <th width="25%">Explained</th>
  </tr>
  <tr>
    <td>appml-controller</td>
    <td>Defines an AppML controller</td>
    <td><a href="appml_controllers.asp">AppML Controllers</a></td>
  </tr>
  <tr>
    <td>appml-data</td>
    <td>Defines the data source for an application</td>
    <td><a href="appml_data.asp">AppML Data</a></td>
  </tr>
  <tr>
    <td>appml-include-html</td>
    <td>Defines HTML to be included</td>
    <td><a href="appml_includes.asp">AppML Includes</a></td>
  </tr>
  <tr>
    <td>appml-repeat</td>
    <td>Defines an HTML element to be repeated</td>
    <td><a href="appml_howto.asp">AppML Howto</a></td>
  </tr>
</table>

<hr>

<h2>AppML Messages</h2>
<div class="w3-example">
 <h3>Example</h3>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryappml_ref_messages" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>ready</td>
    <td>After AppML is initiated, and ready to load data.</td>
  </tr>
    <tr>
    <td>loaded</td>
    <td>After AppML is fully loaded, ready to display data.</td>
    </tr>
    <tr>
    <td>display</td>
    <td>Before AppML displays a data item.</td>
    </tr>
  <tr>
    <td>done</td>
    <td>After AppML is done (finished displaying).</td>
  </tr>
    <tr>
    <td>submit</td>
    <td>Before AppML submits data.</td>
    </tr>
  <tr>
    <td>error</td>
    <td>After AppML has encountered an error.</td>
  </tr>
</table>


<p>AppML messages are explained in the chapter about
<a href="appml_messages.asp">AppML messages</a>.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>"data"</td>
    <td>Defines a flat file source for the model</td>
  </tr>
  <tr>
    <td>"database"</td>
    <td>Defines a database source for the model</td>
  </tr>
  <tr>
    <td>"filteritems"</td>
    <td>Defines filter restrictions</td>
  </tr>
  <tr>
    <td>"rowsperpage"</td>
    <td>Defines number of rows to be fetched per page</td>
  </tr>
  <tr>
    <td>"security"</td>
    <td>Defines the security for the model</td>
  </tr>
  <tr>
    <td>"sortitems"</td>
    <td>Defines sorting restrictions</td>
  </tr>
</table>

<hr>
<h2>Application Security</h2>
<p>You have to be logged in as a member of the "admin" group, to access this 
application:</p>
...
<p>You can add your own private data to the model.</p>
<p>This example suggests restrictions to data:</p>
...
<p>Model data can be used by server applications, and by your AppML controller.</p>
<p>This example uses model data to validate input:</p>

<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
    function myController($appml) {<br>&nbsp;&nbsp;&nbsp;
    if ($appml.message == "submit") {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var price = document.getElementById("price").value;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (price &lt; $appml.model.restrictions.price.min) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $appml.displayError(15, "Price 
    too low!");<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>
    }<br>
</div>
</div>
