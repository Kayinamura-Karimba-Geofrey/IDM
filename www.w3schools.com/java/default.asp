...
<div class="w3-example ws-light-green w3-padding-24">
  <h2>Learn Java</h2>
  <p>Java is a popular programming language.</p>
  <p>Java is used to develop mobile apps, web apps, desktop apps, games and much 
more.</p>
  <a class="w3-btn w3-margin-bottom" href="java_intro.asp" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning Java now &raquo;</a>
</div>
...
<div style="display: flex; align-items: center; gap: 8px; margin-top: -8px;margin-bottom:-5px">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-javadefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-javadefaultsignup" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
</div>
<hr>

<h2>Examples in Each Chapter</h2>
<p>Our &quot;Try it Yourself&quot; editor makes it easy to learn Java. You can edit Java code and view the result 
in your browser.</p>
...
<p><a class="w3-btn w3-margin-bottom ws-green" href="java_exercises.asp" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all Java Exercises</a></p>
<hr>
...
<p><a href="java_quiz.asp" class="w3-button w3-blue w3-round">Start Java Quiz</a></p>
<hr>
<h2>Learn by Examples</h2>
<p>Learn by examples! This tutorial supplements all explanations with clarifying examples.</p>
<p><a href="java_examples.asp" class="w3-button ws-grey ws-hover-black w3-round">See All Java Examples</a></p>
<hr>
...
<h2>Java Exam - Get Your Diploma!</h2>-->
<style>  
