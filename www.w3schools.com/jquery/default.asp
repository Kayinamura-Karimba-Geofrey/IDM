...
<a class="w3-btn w3-margin-bottom"  href="jquery_intro.asp" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning jQuery now &raquo;</a>
</div>
...
<div style="display: flex; align-items: center; gap: 8px; margin-top: -8px;margin-bottom:-5px">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-jquerydefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-jquerydefaultsignup" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
</div>
<hr>

<h2>Examples in Each Chapter</h2>
<p>Our "Try it Yourself" editor makes it easy to learn jQuery. You can edit code and view the result in your browser:</p>
...
<form autocomplete="off" id="w3-exerciseform" action="exercise_jq.asp?filename=exercise_jq_selectors1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Use the correct <strong>selector</strong> to hide all &lt;p&gt; elements.</p>
...
<p><a target="_blank" href="exercise_jq.asp?filename=exercise_jq_selectors1">Start the Exercise</a></p>
</div>
</form>
<hr>
...
<a href="jquery_examples.asp" class="w3-button w3-round w3-light-grey">See All jQuery Examples</a>
<hr><h2>jQuery Quiz Test</h2>
<p>Test your jQuery skills at W3Schools!</p>

<a href="jquery_quiz.asp" class="w3-button w3-blue w3-round">Start jQuery Quiz!</a>
<hr>
