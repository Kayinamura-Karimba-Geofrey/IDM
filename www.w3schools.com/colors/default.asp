...
<div class="w3-code notranslate cssHigh">
  #myDIV {<br>&nbsp; color: blue; /* Blue text color */<br>&nbsp; border: 10px solid currentcolor; 
  /* Blue border color */<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=trycolors_currentcolor" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
