...
<hr>
<div class="w3-row ws-green w3-card-2">
<div class="w3-col ws-green w3-center w3-xxlarge" style="width:140px">W3<br>CSS</div>

<div class="w3-rest w3-container ws-grey">
<p>W3.CSS is a CSS framework for developing websites and web apps.</p>
<p>It provides equality for all browsers (Chrome, Edge, Firefox, Safari, Opera) on all devices
(Desktop, Laptop, Tablet, Mobile).</p>
<p>W3.CSS is free, open source, and uses standard CSS only (no JavaScript).</p> 
<a class="ws-btn w3-margin-bottom"  href="w3css_intro.asp" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning W3.CSS now &raquo;</a>
</div>
...
<h2>Note</h2>
<p><b>w3-grid</b> and <b>w3-flex</b> is new in <b>W3.CSS 5.0</b>.</p>
  <h3>w3-grid vs w3-flex</h3>
  <p><b>w3-grid</b> is for two-dimensional layout, with rows AND columns.</p>
  <p><b>w3-flex</b> is for one-dimensional layout, with rows OR columns.</p>
</div>
...
<p><b>W3.CSS</b> is a modern CSS framework developed by the <b>W3Schools</b> team.
It's similar to Bootstrap when it comes to build responsive, mobile-friendly websites,
but it is lighter, simpler, and faster, and does not rely on JavaScript or external libraries like jQuery.</p>
...
<p>To use W3.CSS in your web site, just add a link to <b>w3.css</b> from your web pages:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>Or download w3.css from:</p>
<p><strong><a href="https://www.w3schools.com/w3css/5/w3.css" target="_blank">
https://www.w3schools.com/w3css/5/w3.css</a></strong></p>
<p>and add a local link to your downloaded w3.css file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<div>
<p><a href="w3css_web.asp" class="w3-button ws-green w3-padding-large w3-hover-black w3-block">
...
<p>We have created 50 responsive W3CSS templates for you to use.</p>
...
<p><a href="tryw3css_templates_gourmet_catering.htm" target="_blank" title="Catering Demo"
class="w3-button w3-light-grey w3-padding-large w3-hover-black">
See Demo &raquo;</a>
...
<p><a href="tryw3css_templates_dark_portfolio.htm" target="_blank" title="Portifolio Demo"
class="w3-button w3-light-grey w3-padding-large w3-hover-black">
See Demo &raquo;</a>
...
<div class="w3-content" style="max-width:800px">
<img src="img_temp_architect.jpg" style="width:100%" alt="Architect Template"><br>
</div>
</div>
<p><a href="tryw3css_templates_architect.htm" target="_blank" title="Architect Demo"
class="w3-button w3-light-grey w3-padding-large w3-hover-black">
See Demo &raquo;</a>
...
<p><a href="tryw3css_templates_cafe.htm" target="_blank" title="Cafe Demo"
class="w3-button w3-light-grey w3-padding-large w3-hover-black">
See Demo &raquo;</a>
...
<p><a href="tryw3css_templates_wedding.htm" target="_blank" title="Wedding Demo"
class="w3-button w3-light-grey w3-padding-large w3-hover-black">
See Demo &raquo;</a>
...
<div class="w3-content" style="max-width:800px">
<a href="tryw3css_templates_design.htm" target="_blank"  title="Design Demo">
<img src="img_temp_design.jpg" style="width:100%" alt="House Design Template"><br>
</div>
</div>
<p><a href="tryw3css_templates_design.htm" target="_blank" title="House Design Demo"
class="w3-button w3-light-grey w3-padding-large w3-hover-black">
See Demo &raquo;</a>
...
<p><a href="tryw3css_templates_food_blog.htm" target="_blank" title="Food Demo"
class="w3-button w3-light-grey w3-padding-large w3-hover-black">
See Demo &raquo;</a><p>

<p><a href="w3css_templates.asp" class="w3-button ws-green w3-padding-large w3-hover-black w3-block">See All Templates &raquo;</a></p>
