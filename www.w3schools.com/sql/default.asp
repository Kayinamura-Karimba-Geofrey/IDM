...
<div style="display: flex; align-items: center; gap: 8px; margin-top: -8px;margin-bottom:-5px" class="ws-hide-on-logged-in">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-sqldefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p class="ws-hide-on-logged-in"><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-sqldefaultsignup" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
<hr>
