...
<div class='w3-main w3-light-grey' id='belowtopnav' style='margin-left:230px;'>
  <div class='w3-row w3-white'>
    ...
    <h1>Vue <span class="color_h1">Tutorial</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="vue_intro.php">Next &#10095;</a>
</div>

<div class="w3-panel ws-info intro">
<h2>Learn Vue</h2>
<p>Vue is a popular JavaScript framework.</p>
<p>User interfaces built in Vue updates automatically when data changes.</p>
<p>Vue is easy to learn.</p>
<a class="w3-btn w3-margin-bottom" href="vue_intro.php" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning Vue now &raquo;</a>
</div>
...
<div style="display: flex; align-items: center; gap: 8px; margin-top: -8px;margin-bottom:-5px">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-vuedefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-vuedefaultsignup" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
</div>
<hr>
<h2>This Tutorial</h2>
<p>This tutorial is specially designed to help you learn Vue as quickly and efficiently as possible.</p>
<p>First, you will learn the basics of Vue: text interpolation, directives, and how to incorporate events and forms into your project.</p>
<p>Then you will learn everything else you need to know about Vue:</p>
<p>Computed properties, watchers, methods, setup for Single-File Components (SFCs, *.vue files), and more.</p>
<hr>
...
<div class="w3-code notranslate htmlHigh">
  &lt;h1&gt;"Hello, World!" Example&lt;/h1&gt;<br><br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.php?filename=tryvue_helloWorld" target="_blank">Try it Yourself »</a>
</div>
<hr>
...
<p>Before you study Vue, you should have a basic understanding of:</p>
<ul>
...
<hr>
<h2>Vue History</h2>
<p>Evan You, a Google employee using AngularJS, started to develop Vue in 2013.</p>
<p>Vue version 1.0 was released in 2015.</p>
<hr>

<div>
<h2>Vue Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_intro1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>What is the name of the programming language missing here?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
Vue is a popular <input name="ex1" maxlength="10" style="width: 11ch;"> framework.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_intro1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
...
<h2>Vue Quiz ?</h2>
<p>Learn by taking a quiz! The quiz will give you a signal of how much you know about Vue.</p>
<p><a href="vue_quiz.php" class="w3-button w3-blue w3-round">Start Vue Quiz</a></p>
<hr>
...
<p><a href="vue_examples.php" class="w3-button w3-light-grey w3-round">See All Vue Examples</a></p>
<hr>
...
<a class="w3-right w3-btn w3-round" href="vue_intro.php" style="font-family: 'Roboto Mono', monospace;background-color:#04AA6D;padding:20px;text-align:right"><span style="color:#D9EEE1">Next &#10095;</span><br class="w3-hide-small"><span class="w3-hide-small"> Vue Introduction</span></a>
</div>
