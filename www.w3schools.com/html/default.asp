...
<div class="ws-learnhtml">
  <div
    class="html-links"
    style="font-family: 'Source Sans Pro Topnav', sans-serif;"
  >
    <div class="html-card html-tutorial">
      ...
      <a
        href="html_intro.asp"
        class="ws-btn ws-green ws-hover-green ga-featured ga-htmlfree w3-margin-top"
        >Learn HTML Now &raquo;</a
      >
    </div>
    ...
    <div class="html-card html-course">
      ...
      <a
        class="ws-btn ws-purple w3-margin-top"
        href="https://profile.w3schools.com/sign-up?redirect_url=https%3A%2F%2Fpathfinder.w3schools.com%2Fcourse-player%3FskillId%3D9eb290f1-fc77-470c-988c-c47f26cfcf86"
        class="ws-purple ga-featured ga-htmlcourse"
        target="_blank"
        ><svg
...
<div style="display: flex; align-items: center; gap: 8px; margin-top: 16px;margin-bottom:-5px">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-htmldefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-htmldefaultsignup" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
</div>
...
<p>
  ...
  <a
    ...
    target="_blank"
    class="ga-featured"
    title="Create a free account to track your progress and earn XP"
    >Sign in</a
  >
