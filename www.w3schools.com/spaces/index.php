...
>
  ...
  <div class="plans-header">
    ...
    <p class="w3-large w3-padding-small">
  ...
  <div class="w3-center plans-section-inner">
    <div class="w3-row plans w3-center">
      <div class="plans-part plans-wrapper">
        <div class="w3-col l6 w3-round-xxlarge ws-white plan-card">
          ...
          <div class="w3-left-align">
            ...
            <ul class="features-list">
              <li class="feature-item">Track your progress</li>
              <li class="feature-item">Set your goals</li>
              <li class="feature-item">Build and host 1 static website</li>
              <li class="feature-item">100 credits/month
                <span class="feature-item-info tooltip-wrapper">
                  <span class="-info-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
                  </span>
                  <span class="-tooltip">Access various AI features like W3Schools kAI coding tutor and interview preparation.</span>
                </span>
              </li>
          ...
          <div class="w3-center btn">
            <a
              class="outline-btn"
              href="https://profile.w3schools.com/sign-up?redirect_url=https%3A%2F%2Fmy-learning.w3schools.com%2F"
            >
              Get Free
            </a>
          </div>
        ...
        <div class="w3-col l6 w3-round-xxlarge ws-white plan-card is-popular">
          ...
          <div class="w3-left-align">
            ...
            <ul class="features-list">
              ...
              <li class="feature-item">Unlimited challenges</li>
              <li class="feature-item">Unlimited practice tests</li>
              ...
              <li class="feature-item">10000 credits/month
                <span class="feature-item-info tooltip-wrapper">
                  <span class="-info-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
                  </span>
          ...
          <div class="w3-center btn">
            <a
              class="outline-btn"
              id="plus_pricing_btn"
              href="https://billing.w3schools.com/products/spaces?frequency=monthly&amp;selectedPlan=plus-monthly"
            >
              Get Plus
            </a>
          </div>
        ...
        <div class="w3-col l6 w3-round-xxlarge ws-white plan-card">
          <div class="card-header">
            <h5 class="card-title">W3Schools Academy</h5>
            <p class="card-price-smaller">For teachers</p>
            <hr />
          </div>
          <div class="w3-left-align">
            <p>Spend less time on admin tasks while engaging your students. Help them learn, practice and collaborate. All in one place.</p>
            <ul class="features-list">
              <li class="feature-item">Ad-free for focused learning</li>
              <li class="feature-item">Dashboard to manage your classroom</li>
              <li class="feature-item">Study plans for structured learning</li>
              <li class="feature-item">Track progress with insights</li>
              <li class="feature-item">Interactive code challenges and projects</li>
              <li class="feature-item">Access to all courses and certification exams</li>
              <li class="feature-item">Spaces for building and publishing projects</li>
            </ul>
          </div>
          <div class="w3-center btn">
            <a
              class="outline-btn"
              href="https://www.w3schools.com/academy/index.php"
              target="_blank"
            >
              Get More Info
            </a>
  ...
  <script>
    function togglePricing(e) {
      if (document.getElementById("plans-toggle-pricing").checked) {
        ...
        document.getElementById("plus_pricing_btn").href = "https://billing.w3schools.com/products/spaces?frequency=yearly&selectedPlan=plus-yearly";
      } else {
        document.getElementById("plus_pricing").innerHTML = "$14.99<span class='card-period'>/Month</span>";
        document.getElementById("plus_pricing_btn").href = "https://billing.w3schools.com/products/spaces?frequency=monthly&selectedPlan=plus-monthly";
      }
    }
  </script>
</div>
