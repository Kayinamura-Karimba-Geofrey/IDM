...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Sass Tutorial</title>
<meta charset="utf-8">
...
<a target="_top" href="default.asp">Sass HOME</a>
<a target="_top" href="sass_intro.asp">Sass Intro</a>
<a target="_top" href="sass_installation.asp">Sass Installation</a>
<a target="_top" href="sass_variables.asp">Sass Variables</a>
<a target="_top" href="sass_nesting.asp">Sass Nesting</a>
<a target="_top" href="sass_import.asp">Sass @import</a>
<a target="_top" href="sass_mixin_include.asp">Sass @mixin</a>
<a target="_top" href="sass_extend.asp" class="not-wired">Sass @extend</a>
<br>
<h2 class="left"><span class="left_h2">Sass</span> Functions</h2>
<a target="_top" href="sass_functions_string.asp">Sass String</a>
<a target="_top" href="sass_functions_numeric.asp">Sass Numeric</a>
<a target="_top" href="sass_functions_list.asp">Sass List</a>
<a target="_top" href="sass_functions_map.asp">Sass Map</a>
<a target="_top" href="sass_functions_selector.asp">Sass Selector</a>
<a target="_top" href="sass_functions_introspection.asp">Sass Introspection</a>
<a target="_top" href="sass_functions_color.asp" class="not-wired">Sass Color</a>
<br>
<h2 class="left"><span class="left_h2">Sass</span> Certificate</h2>
<a target="_top" href="sass_exam.asp" class="no-checkmark">Sass Certificate</a>
...
<h1>Sass <span class="color_h1">Tutorial</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
  <a class="w3-right w3-btn" href="sass_intro.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info w3-padding-24">
<h2>Learn Sass</h2>
<p>Sass is a CSS pre-processor.</p>
<p>Sass reduces repetition of CSS and therefore saves time.</p>
<a class="w3-btn w3-margin-bottom"  href="sass_intro.asp" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning Sass now &raquo;</a>
</div>
...
<div style="display: flex; align-items: center; gap: 8px; margin-top: -8px;margin-bottom:-5px">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-sassdefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-sassdefaultsignup" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
</div>
<hr>
<h2>Examples in Each Chapter</h2>
<p>Our "Show Sass" tool makes it easy to learn Sass, it shows both the code and the result.</p>
<div class="w3-example">
  <h3>Sass Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Define standard variables and values for website */<br>$bgcolor: lightblue;<br>
  $textcolor: darkblue;<br>$fontsize: 18px;<br><br>/* Use the variables */<br>body
{<br>&nbsp;&nbsp;background-color: $bgcolor;<br>&nbsp; color: 
  $textcolor;<br>&nbsp; font-size: $fontsize;<br>}</div>
<p>
<a target="_blank" class="w3-btn" href="showsass.asp?filename=demo_sass_first">Run Example &raquo;</a>
</p>
</div>
<hr>

<h2>Sass Function References</h2>
<p>At W3Schools you will find complete references of all Sass functions with syntax and examples.</p>
<div style="width:230px">
<p><a href="sass_functions_string.asp">Sass String Functions</a></p>
<p><a href="sass_functions_numeric.asp">Sass Numeric Functions</a></p>
<p><a href="sass_functions_list.asp">Sass List Functions</a></p>
<p><a href="sass_functions_map.asp">Sass Map Functions</a></p>
<p><a href="sass_functions_selector.asp">Sass Selector Functions</a></p>
<p><a href="sass_functions_introspection.asp">Sass Introspection Functions</a></p>
<p><a href="sass_functions_color.asp">Sass Color Functions</a></p>
</div>
<hr>
