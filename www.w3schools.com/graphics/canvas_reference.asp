...
<a class="w3-left w3-btn" href="dom_obj_event_methods.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="api_console.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<p>The HTML <b>&lt;canvas&gt;</b> element is a <b>bitmapped</b> area in an HTML page.</p>
<p>The <b>Canvas API</b> allows JavaScript to <b>draw graphics</b> on the canvas.</p>
<p>The Canvas API can draw shapes, lines, curves, boxes, text, and images, with colors,
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas" target="_blank">
  Try it Yourself &raquo;</a>
</div>

<p>You access a <code class="w3-codespan">&lt;canvas&gt;</code> element with the <b>HTML 
DOM</b> method <code class="w3-codespan">getElementById()</code>.</p>
<p>To draw in the canvas you need to create a <b>2D context</b> object:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const myCanvas = document.getElementById("myCanvas");<br>
const ctx = myCanvas.getContext("2d");
</div>
</div>
<div class="ws-note">
<h2>Note</h2>
<p>The HTML <code class="w3-codespan">&lt;canvas&gt;</code> element itself has no drawing abilities.</p>
<p>You must use JavaScript to draw any graphics.</p>
<p>The <code class="w3-codespan">getContext()</code> method returns an object 
with tools (methods) for drawing.</p>
</div>
<hr>
<h2>Paths</h2>
<p>The common way to draw on the canvas is to:
<ol>
<li>Begin a Path - beginPath()</li>
<li>Move to a Point - moveTo()</li>
<li>Draw in the Path - lineTo()</li>
<li>Draw the Path - stroke()</li>
</ol>
</p>
<div class="w3-example">
<p>Example</p>
...
<div class="ws-info">
<h2>Complete Canvas API Reference</h2>
<p>This reference covers all Properties and Methods of the getContext("2d") Object,
used to draw text, lines, boxes, circles, pictures, and more on the canvas.</p>
</div>

<h2>Drawing Methods</h2>
<p>There are only 3 methods to draw directly on the canvas:</p>
...
<table class="ws-table-all notranslate">
 ...
 <hr>
<h2>The ImageData Object / Pixel Manipulation</h2>
<table class="ws-table-all notranslate">
   <tr>
    <th>Method/Property</th>
    <th>Description</th>
...
<p>The canvas object also supports the standard <a href="dom_obj_all.asp">
properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>Canvas tutorial: <a href="/graphics/canvas_intro.asp">Canvas Tutorial</a></p>
...
<p><code class="w3-codespan">Canvas API</code> is supported in all modern browsers:</p>
