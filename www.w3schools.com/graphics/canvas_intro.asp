...
<h2>Learn Canvas</h2>
<p>The HTML <code class="w3-codespan">&lt;canvas&gt;</code> element is used to draw graphics on a web page.</p>
<p>The HTML <code class="w3-codespan">&lt;canvas&gt;</code> element is only a container for graphics. You must use a script to actually draw the graphics.</p>
...
<canvas id="myCanvas" style="width:50%;border:1px solid #c3c3c3;xmargin-top:15px;">
Your browser does not support the &lt;canvas&gt; element.
</canvas>
<p>The graphic above is created with <code class="w3-codespan">&lt;canvas&gt;</code>. It contains four 
objects: a red rectangle, a gradient rectangle, a multicolor rectangle, and a multicolor text.</p>
...
<p>The HTML <code class="w3-codespan">&lt;canvas&gt;</code> element is used to draw graphics, on the fly, via scripting (usually JavaScript).</p>
<p>The <code class="w3-codespan">&lt;canvas&gt;</code> element is only a container for graphics. You must use a script to actually draw the graphics.</p>
<p>Canvas has several methods for drawing paths, boxes, circles, text, and adding images.</p>
...
<p>In HTML, a <code class="w3-codespan">&lt;canvas&gt;</code> element looks like this:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;canvas id="myCanvas&quot; width="200" height="100"&gt;&lt;/canvas&gt;</div>
</div>
<p>The <code class="w3-codespan">id</code> attribute is required (so it can be referred to by JavaScript).</p>
<p>The <code class="w3-codespan">width</code> and <code class="w3-codespan">
height</code> attribute defines the size of the canvas.</p>
<p><b>Tip:</b> The default size of the canvas is 300px (width) x 150px (height).</p>
<p><b>Tip:</b> You can have multiple <code class="w3-codespan">&lt;canvas&gt;</code> elements on one HTML page.</p>
<p>By default, the <code class="w3-codespan">&lt;canvas&gt;</code> element has no 
border and no content.</p>
<p>To add a border, use a <code class="w3-codespan">style</code> attribute:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<div class="ws-note">
<h2>See Also:</h2>
<p><a href="/jsref/api_canvas.asp">W3Schools' Full Canvas Reference</a></p>
</div>
