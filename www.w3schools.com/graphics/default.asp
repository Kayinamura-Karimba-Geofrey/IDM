...
<p><a href="svg_intro.asp">SVG defines vector-based graphics in XML</a>, which can be directly embedded in HTML pages.</p>
...
<h2>HTML Canvas</h2>
<p>The <a href="canvas_intro.asp">HTML &lt;canvas&gt; element</a> element is used to draw graphics, on the fly, with JavaScript:</p>
<canvas id="myCanvas" style="width:50%;border:1px solid #c3c3c3">
Your browser does not support the &lt;canvas&gt; element.
</canvas>
<p>The graphic above shows four elements: a red rectangle, a gradient rectangle,
a multicolor rectangle, and a multicolor text inside a &lt;canvas&gt; element.</p>
...
<h2>Plotting</h2>
<p><a href="plot_graphics.asp">JavaScript libraries</a> are used for both Artificial Intelligence graphs and other charts:</p>
...
<p>Here is an example of a 3D pie made with Google Chart:</p>

<div id="myChart23" style="width:100%;max-width:700px;height:300px"></div>
<script>
...
var options = {
  title:'Worldwide Wine Production',
  is3D:true
};
...
<h2>Google Maps</h2>
<p><a href="google_maps_intro.asp">Google Maps</a> lets you embed maps in HTML 
pages.</p>
<hr>

<h2>HTML + JavaScript Game</h2>
<p><a href="game_intro.asp">Learn how to make a game with HTML and JavaScript</a>.</p>
