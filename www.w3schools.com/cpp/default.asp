...
<a target="_top" href="cpp_memory_management.asp" style="font-size:14px">C++ Memory <span style="font-size:13px">Management</span></a>
<div class="tut_overview">
<a target="_top" href="cpp_memory_management.asp" style="font-size:14.5px">Memory Management</a>
...
<a class="w3-btn w3-margin-bottom" href="cpp_intro.asp" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning C++ now &raquo;</a>
</div>
...
<div style="display: flex; align-items: center; gap: 8px; margin-top: -8px;margin-bottom:-5px">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-cppdefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
</div>
<hr>
