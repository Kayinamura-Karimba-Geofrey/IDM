...
<p><a href="excel_introduction.php" class="w3-btn w3-padding-large w3-hide-small" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning Excel now &raquo;</a></p>
<p><a href="excel_introduction.php" class="w3-btn w3-block w3-hide-large w3-hide-medium" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Learn Excel</a></p>
</div>
...
<div style="display: flex; align-items: center; gap: 8px; margin-top: -8px;margin-bottom:-5px">
  ...
  <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-exceldefaultsignup" style="text-decoration:none"  title="Create a free account to track your progress">
  <span style="font-size: 16px;" title="Create a free account to track your progress">&#x1F3C1;</span></a>
</div>
<p><strong>Tip:</strong> <a href="https://profile.w3schools.com/signup" target="_blank" class="ga-featured ga-exceldefaultsignup" title="Create a free account to track your progress and earn XP">Sign in</a> to track your progress - it's free.</p> 
</div>
...
<p>Example values can be copied from the tutorial and into your spreadsheet, making it easy for you to tag along 
step-by-step:</p>
...
314	44
    ...
    <a class="w3-btn w3-margin-bottom" href="javascript:void(0);" onclick="copyFormulas('demo_excel_move_cells')">Copy Values</a>
</div>
