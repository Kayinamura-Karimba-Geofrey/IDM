...
<div class="w3-center w3-white" style="padding:80px 30px 90px 30px;margin-top:-8px;">
...
<div class="w3-center" style="background-color:#232434;color:white;margin-top:-5px;">
  <div style="background-color:#282A35;margin:auto;padding:70px 20px;">
    <h2 style="font-size:60px;font-weight:700;margin-bottom:25px;" class="textsmallerscreens">W3Schools Spaces</h2>
    <h3 style="margin-top:35px;">Create your own website with <b style="color: #FFC0C7;">W3Schools Spaces</b>, <strong>for free</strong>:</h3>
    <br>
    ...
    <a href="/spaces/index.php" class="ws-btn tut-button" style="font-size:22px;width:300px;padding: 11px 18px;" title="Get Started With W3Spaces">Learn More</a><br>
    <br>
...
<div class="w3-center" style="padding:80px 30px 70px 30px;max-width:770px;margin:auto">
  ...
  <h3 style="margin-top:45px;"><strong>Tip:</strong> Many Front-End Developers also have basic knowledge of different CSS and JavaScript frameworks and libraries, like <a href="/bootstrap5/bootstrap_get_started.php" title="Go To Our Bootstrap 5 Tutorial">Bootstrap</a>, <a href="/sass/sass_intro.asp" title="Go To Our SASS Tutorial">SASS (CSS pre-processor)</a>, <a href="/jquery/jquery_intro.asp" title="Go To Our jQuery Tutorial">jQuery</a> and <a href="/react/react_intro.asp" title="Go To Our React Tutorial">React</a>,<br> and the popular version control system, <a href="/git/default.asp" title="Go To Our Git Tutorial">Git</a>.</h3>
</div>
</div>

<svg style="background-color:#D9EEE1" width="100%" height="70" viewbox="0 0 100 100" preserveAspectRatio="none">
  <path d="M0,0  L110,0C35,150 25,0 0,100z" fill="white" id="wavepath1">
</svg>

<div class="w3-center ws-light-green" style="padding:60px 30px 85px 30px;margin-top:-17px;">

  <div style="max-width:760px;margin:auto;color:black!important;">
    <h2 style="font-size:65px;font-weight:700;;padding-top:65px;" class="textsmallerscreens">What About Back-End?</h2>
    ...
    <h3 style="margin-top:45px;">Front-end code is used to create <b>static</b> websites, where the purpose is to display the web page. However, if you want to make your website <b>dynamic</b> (manage files and databases, 
    ...
    <h3 style="margin-top:45px;">If you already have some backend experience, you should know that you can use <a href="/spaces/index.php">W3Schools Spaces</a> to build, test and deploy backend code as well.</h3>
      <a class="signup-button ws-btn" href="https://www.w3schools.com/spaces/" style="background-color: #282A35; color: #ffffff; padding-left:45px;padding-right:45px;margin-top :15px;font-size:19px;padding-top:10px;padding-bottom:10px;border-radius:25px;">Learn More</a>
    <h3 style="margin-top:45px">A list of other popular languages can be found on our <a href="https://www.w3schools.com" title="Back To W3schools.com">Homepage</a>.</h3>
  </div>
</div>
...
.sidebarpath button:hover, .topic:hover {
  background-color: #dedede;
}
.sidebarpath button.active {
...
.topic.selected .checkbox {
  border-color: #4CAF50;
}
.topic.selected .checkbox .checkmark {
  display: block;
  color: #4CAF50;
  font-size: 10px;
  font-weight: bold;
...
<div class="w3-white">
<div class="w3-center" style="padding:60px 40px 90px 40px;max-width:1200px;margin:auto">
  <h2 style="font-size:55px;font-weight:700;" class="textsmallerscreens">Log In To Create<br>Your Own Learning Path</h2>
  <h3 style="margin-top:45px;">Create a W3Schools account to build your own learning path and set yourself a goal.</h3>
  <h3 style="margin-bottom:50px;">Learn in a structured way and track your progress as you improve.</h3>
    <h5 style="margin-bottom:20px;" class="w3-hide-small w3-hide-medium">Select a Predefined Path, or pick one or more topics you want to learn:</h5>

<div class="w3-hide-small w3-hide-medium">
 <div class="containerpath">
    <div class="sidebarpath">
      <button onclick="selectPath('Frontend Development', this)">Frontend Development</button>
      <button onclick="selectPath('Backend Development', this)">Backend Development</button>
      <button onclick="selectPath('Fullstack Development', this)">Fullstack Development</button>
      <button onclick="selectPath('Mobile Development', this)">Mobile Development</button>
      <button onclick="selectPath('Data Analytics', this)">Data Analytics</button>
    </div>
    <div class="topics" id="topics">
    </div>
  </div>
  <div class="footerpath">
    <p id="selectedCount">You have selected <b>0</b> Topics.</p><br>
    <button style="font-size:12px;border-radius:8px;cursor:pointer;"  id="cancelBtn" onclick="cancelSelection()" disabled>Remove Selected Topic(s)</button>
    <a class="ws-btn ga-featured ga-wheretostart-signup" style="text-decoration:none" target="_blank" href="https://profile.w3schools.com/signup">Sign Up to Create a Learning Path &raquo;</a>
  </div>
</div>
    <a class="ws-btn w3-hide-large ga-featured ga-wheretostart-signup" style="text-decoration:none" href="https://profile.w3schools.com/signup">Sign Up to Create Learning Path &raquo;</a>
  <script>
const topicsList = [
  "HTML", "CSS", "JavaScript", "SQL",
  "Python", "Java", "PHP", "C",
  "C++", "C#", "Bootstrap 3", "Bootstrap 4",
  "Bootstrap 5", "React", "MySQL", "jQuery",
  "Django", "NumPy", "Pandas", "Node.js",
  "R", "TypeScript", "Angular", "AngularJS",
  "Git", "PostgreSQL", "MongoDB", "ASP",
  "Go", "Kotlin", "SASS",
  "Vue.js", "DSA", "SciPy", "Cyber Security",
  "Data Science", "Accessibility",
  "Excel", "XML", "W3.CSS", "Statistics"
];

    const predefinedPaths = {
      "Frontend Development": ["HTML", "CSS", "JavaScript", "React", "TypeScript", "Git"],
      "Backend Development": ["Python", "TypeScript", "PostgreSQL", "Node.js", "SQL", "MySQL", "MongoDB", "Git"],
      "Fullstack Development": ["HTML", "CSS", "JavaScript", "SQL", "MySQL", "PostgreSQL", "Python", "Git", "React", "Node.js"],
      "Mobile Development": ["Java", "JavaScript", "Git", "TypeScript", "Kotlin", "React"],
      "Data Analytics": ["Python", "R", "SQL", "NumPy", "Pandas", "SciPy"]
    };
    ...
    topicsList.forEach(topic => {
      ...
      div.innerHTML = `<span class="checkbox"><span class="checkmark">&#10004;</span></span><span class="label">${topic}</span>`;
...
function updateCount() {
  ...
  document.getElementById('selectedCount').textContent = `You have selected ${count} Topics.`;
  document.getElementById('cancelBtn').disabled = count === 0;
}

    function selectPath(pathName, btn) {
      const button = btn;
      const isActive = button.classList.contains('active');

      document.querySelectorAll('.sidebarpath button').forEach(b => b.classList.remove('active'));
      ...
      if (!isActive) {
        ...
        const topicsToSelect = predefinedPaths[pathName] || [];
        document.querySelectorAll('.topic').forEach(div => {
          const value = div.getAttribute('data-topic');
          if (topicsToSelect.includes(value)) {
    ...
    function cancelSelection() {
      ...
      document.querySelectorAll('.sidebarpath button').forEach(btn => btn.classList.remove('active'));
      updateCount();
    }
  </script>
