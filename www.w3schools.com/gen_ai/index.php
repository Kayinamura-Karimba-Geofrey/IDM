...
<h2 class="left"><span class="left_h2">AI Prompt</span> Tutorial</h2>
<a target="_top" href="index.php">AI Prompt Home</a>
<a target="_top" href="gen_ai_prompt_intro.php" class="not-wired">AI Prompt Intro</a>
<br>
<h2 class="left"><span class="left_h2">AI</span> text-to-text</h2>
<a target="_top" href="gen_ai_prompt_text-to-text_intro.php">AI text-to-text Intro</a>
<a target="_top" href="gen_ai_chatgpt-3-5.php">AI ChatGPT-3.5</a>
<a target="_top" href="gen_ai_chatgpt-4.php">AI ChatGPT-4</a>
<a target="_top" href="gen_ai_bard.php" class="not-wired">AI Bard</a>
<!--
<br>
<h2 class="left"><span class="left_h2">AI</span> text-to-image</h2>
<a target="_top" href="gen_ai_prompt_text-to-image_intro.php">AI text-to-image Intro</a>
<a target="_top" href="midjourney5/index.php">AI Midjourney 5</a>
-->        <br><br>
    </div>
  </div>
</div>
<div class='w3-main w3-light-grey' id='belowtopnav' style='margin-left:230px;'>
  <div class='w3-row w3-white'>
    ...
    <h1>Generative AI Tutorial</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="gen_ai_prompt_intro.php">Next &#10095;</a>
</div>

<div class="w3-panel ws-info w3-padding-24 w3-pale-red">

  <div class="w3-hide-small red-intro-emoji">[+:</div>
  <h2>Learn Generative AI</h2>
  <p>Generative AI can help boost your productivity if used correctly.</p>
  <p>AI prompt engineering is one of the hottest jobs in tech.</p>
  <p>Knowing how to write prompts correctly is the key to helping you use generative AIs.</p>
  <a class="w3-btn w3-margin-bottom startlearningbtn" href="gen_ai_prompt_intro.php">Start learning AI Prompt Engineering now &#10095;</a>
</div>
...
<p>In these tutorials, you get step-by-step guides on how to write AI prompts to get the best possible results from text-to-text and text-to-image generative AIs.</p>

<p>You will learn to understand Generative AI capabilities and write prompts that minimize misinformation and biased results.</p>
...
<p>In these tutorials, we will use examples to better explain the various concepts.</p>
...
<h3>Example</h3>
  ...
  <div class="w3-white w3-padding">
   <img src="img_example_eli5.png" style="width:100%;max-width:800px;"> </div>
</div>
<hr>
<style>
.containerlog {
