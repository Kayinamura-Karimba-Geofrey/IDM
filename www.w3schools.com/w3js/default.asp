...
<a class="w3-left w3-btn ws-green" href="/default.asp">&#10094; Previous</a>
<a class="w3-right w3-btn ws-green" href="w3js_intro.asp">Next &#10095;</a>
</div>
<hr>
...
<a class="w3-bar-item w3-button ws-grey" href="w3js_slideshow.asp">Run HTML Slideshows</a>
<a class="w3-bar-item w3-button ws-grey w3-border-top" href="w3js_html_include.asp">Include (Import) HTML in HTML</a>
<a class="w3-bar-item w3-button ws-grey w3-border-top" href="w3js_sort.asp">Sort the Content of any HTML Element</a>
<a class="w3-bar-item w3-button ws-grey w3-border-top" href="w3js_filters.asp">Filter the Content of any HTML Element</a>
<a class="w3-bar-item w3-button ws-grey w3-border-top" href="w3js_display.asp">Display JavaScript Objects in HTML</a>
<a class="w3-bar-item w3-button ws-grey w3-border-top" href="w3js_http.asp">Read Data from Web Servers (Http Request)</a>
<a class="w3-bar-item w3-button ws-grey w3-border-top" href="w3js_hide.asp">Hide or Show any HTML Element</a>
<a class="w3-bar-item w3-button ws-grey w3-border-top" href="w3js_add_class.asp">Add or Remove Classes on any HTML Element</a>
<a class="w3-bar-item w3-button ws-grey w3-border-top" href="w3js_add_style.asp">Add CSS to any HTML Element</a>
</div>
<hr>
...
<p><a class="ws-btn w3-dark-grey" href="w3js_examples.asp">Go to W3.JS Examples!</a></p>
<hr>
...
<p><a class="ws-btn w3-dark-grey" href="w3js_references.asp">W3.JS References</a></p>
<hr>
