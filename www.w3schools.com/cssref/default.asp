...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="css4_pr_accent-color.php">accent-color</a></td>
  ...
  <tr>
    ...
    <td>Specifies whether an animation should be played forward, backward or 
  ...
  <tr>
    <td><a href="css_pr_aspect-ratio.php">aspect-ratio</a></td>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="css3_pr_backdrop-filter.php">backdrop-filter</a></td>
    <td>Defines a graphical effect to the area behind an element</td>
  </tr>
  <tr>
    <td><a href="css3_pr_backface-visibility.php">backface-visibility</a></td>
  ...
  <tr>
    <td><a href="css_pr_background-position-x.php">background-position-x</a></td>
    <td>Specifies the position of a background image on x-axis</td>
  </tr>
  <tr>
    <td><a href="css_pr_background-position-y.php">background-position-y</a></td>
  ...
  <tr>
    <td><a href="css_pr_block-size.php">block-size</a></td>
  ...
  <tr>
    <td><a href="css_pr_border-block.php">border-block</a></td>
    <td>A shorthand property for <em>border-block-width, border-block-style</em> and <em>border-block-color</em></td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-color.php">border-block-color</a></td>
    <td>Sets the color of the borders at start and end in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-end.php">border-block-end</a></td>
    <td>A shorthand property for <em>border-block-end-width, border-block-end-style</em> and <em>border-block-end-color</em></td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-end-color.php">border-block-end-color</a></td>
    <td>Sets the color of the border at the end in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-end-style.php">border-block-end-style</a></td>
    <td>Sets the style of the border at the end in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-end-width.php">border-block-end-width</a></td>
    <td>Sets the width of the border at the end in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-start.php">border-block-start</a></td>
    <td>A shorthand property for <em>border-block-start-width, border-block-start-style</em> and <em>border-block-start-color</em></td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-start-color.php">border-block-start-color</a></td>
    <td>Sets the color of the border at the start in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-start-style.php">border-block-start-style</a></td>
    <td>Sets the style of the border at the start in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-start-width.php">border-block-start-width</a></td>
    <td>Sets the width of the border at the start in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-style.php">border-block-style</a></td>
    <td>Sets the style of the borders at start and end in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-block-width.php">border-block-width</a></td>
    <td>Sets the width of the borders at start and end in the block direction</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="css_pr_border-end-end-radius.php">border-end-end-radius</a></td>
    <td>Sets the radius of the corner between the block-end and the inline-end 
    sides of the element</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-end-start-radius.php">border-end-start-radius</a></td>
    <td>Sets the radius of the corner between the block-end and the inline-start 
    sides of the element</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="css_pr_border-inline.php">border-inline</a></td>
    <td>A shorthand property for <em>border-inline-width, border-inline-style</em> and <em>border-inline-color</em></td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-color.php">border-inline-color</a></td>
    <td>Sets the color of the borders at start and end in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-end.php">border-inline-end</a></td>
    <td>A shorthand property for <em>border-inline-end-width, border-inline-end-style</em> and <em>border-inline-end-color</em></td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-end-color.php">border-inline-end-color</a></td>
    <td>Sets the color of the border at the end in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-end-style.php">border-inline-end-style</a></td>
    <td>Sets the style of the border at the end in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-end-width.php">border-inline-end-width</a></td>
    <td>Sets the width of the border at the end in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-start.php">border-inline-start</a></td>
    <td>A shorthand property for <em>border-inline-start-width, border-inline-start-style</em> and <em>border-inline-start-color</em></td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-start-color.php">border-inline-start-color</a></td>
    <td>Sets the color of the border at the start in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-start-style.php">border-inline-start-style</a></td>
    <td>Sets the style of the border at the start in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-start-width.php">border-inline-start-width</a></td>
    <td>Sets the width of the border at the start in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-style.php">border-inline-style</a></td>
    <td>Sets the style of the borders at start and end in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-inline-width.php">border-inline-width</a></td>
  ...
  <tr>
    <td><a href="css_pr_border-start-end-radius.php">border-start-end-radius</a></td>
    <td>Sets the radius of the corner between the block-start and the inline-end 
    sides of the element</td>
  </tr>
  <tr>
    <td><a href="css_pr_border-start-start-radius.php">border-start-start-radius</a></td>
    <td>Sets the radius of the corner between the block-start and the inline-start 
    sides of the element</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="css_pr_box-reflect.php">box-reflect</a></td>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="atrule_charset.php">@charset</a></td>
  ...
  <tr>
    ...
    <td>Deprecated in favor of clip-path. Clips an absolutely positioned element</td>
  </tr>
  <tr>
    <td><a href="css3_pr_clip-path.php">clip-path</a></td>
    <td>Clips an element to a basic shape or to an SVG source</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="css3_pr_color-scheme.php">color-scheme</a></td>
    <td>Indicates which operating system color scheme an element should render 
    with</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="atrule_container.php">@container</a></td>
    <td>Define styles for elements in container, depending on the container's 
    size or style</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="pr_gen_counter-set.php">counter-set</a></td>
    <td>Creates or sets one or more CSS counters</td>
  </tr>
  <tr>
    <td><a href="atrule_counter-style.php">@counter-style</a></td>
    <td>Lets you define your own counter styles</td>
  </tr>
  <tr>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="pr_tab_empty-cells.php">empty-cells</a></td>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="css3_pr_filter.php">filter</a></td>
  ...
  <tr>
    <td><a href="atrule_font-face.php">@font-face</a></td>
    <td>Specifies a custom font to use to display text</td>
    </tr>
  <tr>
  ...
  <tr>
    <td><a href="atrule_font-palette-values.php">@font-palette-values</a></td>
    <td>Allows you to customize the default values of a font-palette</td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Preserves the readability and size of text when fallback font occurs</td>
    </tr>
  <tr>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="css3_pr_hanging-punctuation.php">hanging-punctuation</a></td>
  ...
  <tr>
    ...
    <td>Sets how to split words to improve the layout of text</td>
  </tr>
  <tr>
    <td><a href="css3_pr_hyphenate-character.php">hypenate-character</a></td>
    <td>Sets the character used at the end of line, before a hyphenation break</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="css3_pr_justify-content.php">justify-content</a></td>
  ...
  <tr>
    <td><a href="css_pr_justify-items.php">justify-items</a></td>
    <td>Is set on the grid container. Specifies the alignment of grid items in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_justify-self.php">justify-self</a></td>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="atrule_keyframes.php">@keyframes</a></td>
    <td>Controls the steps in an animation by defining styles for points along 
    the animation sequence</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="atrule_layer.php">@layer</a></td>
    <td>Controls how the CSS cascade layers evaluates the order of styles</td>
  </tr>
  <tr>
    <td><a href="pr_pos_left.php">left</a></td>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="pr_margin.php">margin</a></td>
    <td>Sets all the margin properties in one declaration</td>
  </tr>
  <tr>
    <td><a href="css_pr_margin-block.php">margin-block</a></td>
    <td>Specifies the margin in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_margin-block-end.php">margin-block-end</a></td>
    <td>Specifies the margin at the end in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_margin-block-start.php">margin-block-start</a></td>
  ...
  <tr>
    <td><a href="css_pr_margin-inline.php">margin-inline</a></td>
    <td>Specifies the margin in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_margin-inline-end.php">margin-inline-end</a></td>
    <td>Specifies the margin at the end in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_margin-inline-start.php">margin-inline-start</a></td>
  ...
  <tr>
    <td><a href="css3_pr_marker.php">marker</a></td>
    <td>Points to a marker that will be drawn on all vertices of an element's 
    path (the first, middle, and last)</td>
  </tr>
  <tr>
    <td><a href="css3_pr_marker-end.php">marker-end</a></td>
    <td>Points to a marker that will be drawn on the last vertex of an element's 
    path</td>
  </tr>
  <tr>
    <td><a href="css3_pr_marker-mid.php">marker-mid</a></td>
    <td>Points to a marker that will be drawn on all the middle vertices of an 
    element's path</td>
  </tr>
  <tr>
    <td><a href="css3_pr_marker-start.php">marker-start</a></td>
    <td>Points to a marker that will be drawn on the first vertex of an 
    element's path</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask.php">mask</a></td>
    <td>A shorthand property for <em>mask-image</em>, <em>mask-mode</em>, <em>
    mask-repeat</em>, <em>mask-position</em>, <em>mask-clip</em>, <em>mask-origin</em>,
    <em>mask-size</em> and <em>mask-composite</em></td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-clip.php">mask-clip</a></td>
    <td>Specifies which area is affected by a mask image</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-composite.php">mask-composite</a></td>
    <td>Specifies a compositing operation used on the current mask layer with 
    the mask layers below it</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-image.php">mask-image</a></td>
    <td>Specifies an image to be used as a mask layer for an element</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-mode.php">mask-mode</a></td>
    <td>Specifies whether the mask layer image is treated as a luminance mask or 
    as an alpha mask</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-origin.php">mask-origin</a></td>
    <td>Specifies the origin position (the mask position area) of a mask layer image</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-position.php">mask-position</a></td>
    <td>Sets the starting position of a mask layer image (relative to the 
    mask position area)</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-repeat.php">mask-repeat</a></td>
    <td>Specifies how the mask layer image is repeated</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-size.php">mask-size</a></td>
    <td>Specifies the size of a mask layer image</td>
  </tr>
  <tr>
    <td><a href="css3_pr_mask-type.php">mask-type</a></td>
  ...
  <tr>
    <td><a href="atrule_media.php">@media</a></td>
    <td>Sets the style rules for different media types/devices/sizes</td>
  </tr>
  <tr>
    <td><a href="css_pr_max-block-size.php">max-block-size</a></td>
    <td>Sets the maximum size of an element in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_max-inline-size.php">max-inline-size</a></td>
    <td>Sets the maximum size of an element in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_min-block-size.php">min-block-size</a></td>
    <td>Sets the minimum size of an element in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_min-inline-size.php">min-inline-size</a></td>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="atrule_namespace.php">@namespace</a></td>
    <td>Defines an XML namespace to be used in the style sheet</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="css3_pr_object-fit.php">object-fit</a></td>
  ...
  <tr>
    <td><a href="css_pr_offset.php">offset</a></td>
    <td>A shorthand property for the <em>offset-anchor</em>, <em>offset-distance</em>,
    <em>offset-path</em>, <em>offset-position</em>, and the <em>offset-rotate</em> 
    properties</td>
  </tr>
  <tr>
    <td><a href="css_pr_offset-anchor.php">offset-anchor</a></td>
    <td>Specifies a point on an element that is fixed to the path it is animated along</td>
  </tr>
  <tr>
    <td><a href="css_pr_offset-distance.php">offset-distance</a></td>
    <td>Specifies the position along a path where an animated element is placed</td>
  </tr>
  <tr>
    <td><a href="css_pr_offset-path.php">offset-path</a></td>
    <td>Specifies the path an element is animated along</td>
  </tr>
  <tr>
    <td><a href="css_pr_offset-position.php">offset-position</a></td>
    <td>Specifies the initial position of an element along a path</td>
  </tr>
  <tr>
    <td><a href="css_pr_offset-rotate.php">offset-rotate</a></td>
  ...
  <tr>
    <td><a href="css3_pr_orphans.php">orphans</a></td>
  ...
  <tr>
    <td><a href="css_pr_overflow-anchor.php">overflow-anchor</a><br>
    </td>
  ...
  <tr>
    <td><a href="css3_pr_overflow-wrap.php">overflow-wrap</a></td>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="pr_padding.php">padding</a></td>
    <td>A shorthand property for all the <em>padding-*</em> properties</td>
  </tr>
  <tr>
    <td><a href="css_pr_padding-block.php">padding-block</a></td>
    <td>Specifies the padding in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_padding-block-end.php">padding-block-end</a></td>
    <td>Specifies the padding at the end in the block direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_padding-block-start.php">padding-block-start</a></td>
  ...
  <tr>
    <td><a href="css_pr_padding-inline.php">padding-inline</a></td>
    <td>Specifies the padding in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_padding-inline-end.php">padding-inline-end</a></td>
    <td>Specifies the padding at the end in the inline direction</td>
  </tr>
  <tr>
    <td><a href="css_pr_padding-inline-start.php">padding-inline-start</a></td>
  ...
  <tr>
    <td><a href="atrule_page.php">@page</a></td>
    <td>Customizes the dimension, orientation, and margins of printed pages</td>
  </tr>
  <tr>
    <td><a href="pr_print_pageba.php">page-break-after</a></td>
    <td>Sets the page-break behavior after an element. Replaced by <code class="w3-codespan"><a href="pr_break-after.php">break-after</a></code> property</td>
  </tr>
  <tr>
    <td><a href="pr_print_pagebb.php">page-break-before</a></td>
    <td>Sets the page-break behavior before an element. Replaced by <code class="w3-codespan"><a href="pr_break-before.php">break-before</a></code> property</td>
  </tr>
  <tr>
    <td><a href="pr_print_pagebi.php">page-break-inside</a></td>
    <td>Sets the page-break behavior inside an element. Replaced by <code class="w3-codespan"><a href="pr_break-inside.php">break-inside</a></code> property</td>
  </tr>
  <tr>
    <td><a href="css_pr_paint-order.php">paint-order</a></td>
  ...
  <tr>
    <td><a href="atrule_property.php">@property</a></td>
    <td>Defines custom CSS properties directly in the stylesheet without having to run any JavaScript</td>
  </tr>  
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="css_pr_rotate.php">rotate</a></td>
    <td>Specifies the rotation of an element</td>
  </tr>
  <tr>
    <td><a href="css3_pr_row-gap.php">row-gap</a></td>
...
<table class="ws-table-all notranslate">
<tr>
    <td><a href="css_pr_scale.php">scale</a></td>
    <td>Specifies the size of an element by scaling up or down</td>
  </tr>
  <tr>
    <td><a href="atrule_scope.php">@scope</a></td>
    <td>Allows you to select elements in specific DOM subtrees and target 
    elements precisely without writing overly-specific selectors</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="css_pr_scroll-margin-top.php">scroll-padding-inline-start</a></td>
  ...
  <tr>
    <td><a href="css_pr_scroll-margin-top.php">scroll-padding-left</a></td>
    <td>Specifies the distance from the left side of the container to the snap position on the child elements</td>
  </tr>
  <tr>
    <td><a href="css_pr_scroll-margin-top.php">scroll-padding-right</a></td>
    <td>Specifies the distance from the right side of the container to the snap position on the child elements</td>
  </tr>
  <tr>
    <td><a href="css_pr_scroll-margin-top.php">scroll-padding-top</a></td>
    <td>Specifies the distance from the top of the container to the snap position on the child elements</td>
  </tr>
  <tr>
    <td><a href="css_pr_scroll-snap-align.php">scroll-snap-align</a></td>
    <td>Specifies where to position elements when the user stops scrolling</td>
  </tr>
  <tr>
    <td><a href="css_pr_scroll-snap-stop.php">scroll-snap-stop</a></td>
    <td>Specifies scroll behaviour after fast swipe on trackpad or touch screen</td>
  </tr>
  <tr>
    <td><a href="css_pr_scroll-snap-type.php">scroll-snap-type</a></td>
    <td>Specifies how snap behaviour should be when scrolling</td>
  </tr>
  <tr>
    <td><a href="css_pr_scrollbar-color.php">scrollbar-color</a></td>
    <td>Specifies the color of the scrollbar of an element</td>
  </tr>
  <tr>
    <td><a href="css_pr_shape-outside.php">shape-outside</a></td>
    <td>Defines a shape for wrapping for the inline content</td>
  </tr>
  <tr>
    <td><a href="atrule_starting-style.php">@starting-style</a></td>
    <td>Defines an element's starting styles before the element gets its first 
    style update</td>
  </tr>
  <tr>
    <td><a href="atrule_supports.php">@supports</a></td>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="pr_text_text-decoration-thickness.php">
    text-decoration-thickness</a></td>
    <td>Specifies the thickness of the decoration line</td>
  </tr>
  <tr>
    <td><a href="css3_pr_text-emphasis.php">text-emphasis</a></td>
    <td>A shorthand property for the <em>text-emphasis-style</em> and <em>
    text-emphasis-color</em> properties</td>
  </tr>
  <tr>
    <td><a href="css3_pr_text-emphasis-color.php">text-emphasis-color</a></td>
    <td>Specifies the color of emphasis marks</td>
  </tr>
  <tr>
    <td><a href="css3_pr_text-emphasis-position.php">text-emphasis-position</a></td>
    <td>Specifies the position of emphasis marks</td>
  </tr>
  <tr>
    <td><a href="css3_pr_text-emphasis-style.php">text-emphasis-style</a></td>
    <td>Specifies the style of emphasis marks</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="css_pr_text-orientation.php">text-orientation</a></td>
  ...
  <tr>
    <td><a href="css3_pr_text-underline-offset.php">text-underline-offset</a></td>
    <td>Specifies the offset distance of the underline text decoration</td>
  </tr>
  <tr>
    <td><a href="css3_pr_text-underline-position.php">text-underline-position</a></td>
    <td>Specifies the position of the underline text decoration</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="css_pr_translate.php">translate</a></td>
...
<table class="ws-table-all notranslate">
  <tr>
    ...
    <td>Used together with the <a href="pr_text_direction.php">direction</a> property to set or return whether the text should be overridden to support multiple languages in the same document</td>
  </tr>
  <tr>
...
<table class="ws-table-all notranslate">
  <tr>
    <td><a href="pr_pos_vertical-align.php">vertical-align</a></td>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="css3_pr_widows.php">widows</a></td>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="css3_pr_zoom.php">zoom</a></td>
    <td>Specifies the zoom factor for an element. An element can be zoomed in and out</td>
  </tr>
</table>
</div>
