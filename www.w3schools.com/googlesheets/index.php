...
<html lang="en-US">
<head>
<title>Google Sheets Tutorial</title>
<meta charset="utf-8">
...
<h2 class="left"><span class="left_h2">GS Tutorial</span></h2>
<a target="_top" href="index.php">GS HOME</a>
<a target="_top" href="google_sheets_introduction.php">GS Introduction</a>
<a target="_top" href="google_sheets_get_started.php">GS Get Started</a>
<a target="_top" href="google_sheets_overview.php">GS Overview</a>
<a target="_top" href="google_sheets_syntax.php">GS Syntax</a>
<a target="_top" href="google_sheets_ranges.php">GS Ranges</a>
<a target="_top" href="google_sheets_filling.php">GS Fill</a>
<div class="tut_overview">
<a target="_top" href="google_sheets_filling.php">Filling</a>
<a target="_top" href="google_sheets_double_click.php">Double Click to Fill</a>
</div>
<a target="_top" href="google_sheets_move_cells.php">GS Move Cells</a>
<a target="_top" href="google_sheets_add_cells.php">GS Add Cells</a>
<a target="_top" href="google_sheets_delete_cells.php">GS Delete Cells</a>
<a target="_top" href="google_sheets_undo_redo.php">GS Undo Redo</a>
<a target="_top" href="google_sheets_formulas.php">GS Formulas</a>
<a target="_top" href="google_sheets_rel_ref.php">GS Relative Reference</a>
<a target="_top" href="google_sheets_abs_ref.php">GS Absolute Reference</a>
<a target="_top" href="google_sheets_addition.php">GS Arithmetic Operators</a>
<div class="tut_overview">
<a target="_top" href="google_sheets_addition.php">GS Addition</a>
<a target="_top" href="google_sheets_subtraction.php">GS Subtraction</a>
<a target="_top" href="google_sheets_multiplication.php">GS Multiplication</a>
<a target="_top" href="google_sheets_division.php">GS Division</a>
</div>
<a target="_top" href="google_sheets_parentheses.php">GS Parentheses</a>
<a target="_top" href="google_sheets_functions.php">GS Functions</a>
<a target="_top" href="google_sheets_location_settings.php" class="not-wired">GS Location Settings</a>
<br>

<h2>GS Formatting</h2>
<a target="_top" href="google_sheets_formatting.php">GS Formatting</a>
<a target="_top" href="google_sheets_format_painter.php">GS Format Painter</a>
<a target="_top" href="google_sheets_format_colors.php">GS Format Colors</a>
<a target="_top" href="google_sheets_format_fonts.php">GS Format Fonts</a>
<div class="tut_overview">
<a target="_top" href="google_sheets_format_fonts.php">Fonts</a>
<a target="_top" href="google_sheets_format_font_color.php">Font Color</a>
<a target="_top" href="google_sheets_format_font_size.php">Font Size</a>
<a target="_top" href="google_sheets_format_font_characteristics.php">Font Characteristics</a>

</div>
<a target="_top" href="google_sheets_format_borders.php">GS Format Borders</a>
<a target="_top" href="google_sheets_format_numbers.php">GS Format Numbers</a>
<a target="_top" href="google_sheets_format_gridlines.php">GS Format Grids</a>
<a target="_top" href="google_sheets_clear_format.php" class="not-wired">GS Format Clear</a>

<br>

<h2>GS Data Analysis</h2>
<a target="_top" href="google_sheets_sort.php">GS Sort</a>
<a target="_top" href="google_sheets_sort_sheet.php">GS Sort Sheet</a>
<a target="_top" href="google_sheets_sort_by_range.php">GS Sort By Range</a>
<a target="_top" href="google_sheets_sort_range.php">GS Sort Range</a>
<a target="_top" href="google_sheets_conditional_formatting.php">GS Conditional Formatting</a>
<a target="_top" href="google_sheets_cf_single_color.php">GS<span style="font-size:95%"> Single Color Formatting</span></a>
<a target="_top" href="google_sheets_cf_color_scale.php" class="not-wired">GS Color Scale Formatting</a>

<br>

<h2 class="left"><span class="left_h2">GS Functions</span></h2>
<a target="_top" href="google_sheets_and.php">AND</a>
<a target="_top" href="google_sheets_average.php">AVERAGE</a>
<a target="_top" href="google_sheets_averageif.php">AVERAGEIF</a>
<a target="_top" href="google_sheets_averageifs.php">AVERAGEIFS</a>
<a target="_top" href="google_sheets_count.php">COUNT</a>
<a target="_top" href="google_sheets_counta.php">COUNTA</a>
<a target="_top" href="google_sheets_countblank.php">COUNTBLANK</a>
<a target="_top" href="google_sheets_countif.php">COUNTIF</a>
<a target="_top" href="google_sheets_countifs.php">COUNTIFS</a>
<a target="_top" href="google_sheets_if.php">IF</a>
<a target="_top" href="google_sheets_ifs.php">IFS</a>
<a target="_top" href="google_sheets_max.php">MAX</a>
<a target="_top" href="google_sheets_median.php">MEDIAN</a>
<a target="_top" href="google_sheets_min.php">MIN</a>
<a target="_top" href="google_sheets_mode.php">MODE</a>
<a target="_top" href="google_sheets_or.php">OR</a>
<a target="_top" href="google_sheets_stdevp.php">STDEV.P</a>
<a target="_top" href="google_sheets_stdevs.php">STDEV.S</a>
<a target="_top" href="google_sheets_sum.php">SUM</a>
<a target="_top" href="google_sheets_sumif.php">SUMIF</a>
<a target="_top" href="google_sheets_sumifs.php">SUMIFS</a>
<a target="_top" href="google_sheets_vlookup.php">VLOOKUP</a>
<a target="_top" href="google_sheets_xor.php" class="not-wired">XOR</a>
<br>
...
<h1>Google Sheets Tutorial</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="/default.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="google_sheets_introduction.php">Next &#10095;</a>
</div>

<div class="w3-panel ws-info w3-padding-24">
<h2>Learn Google Sheets</h2>
  <p>Google Sheets is a widely used spreadsheet program</p>
  <p>Google Sheets is a powerful tool to use for mathematical functions</p>
  <p><a href="google_sheets_introduction.php" class="w3-btn w3-padding-large w3-hide-small" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning Google Sheets now &raquo;</a></p>
  <p><a href="google_sheets_introduction.php" class="w3-btn w3-block w3-hide-large w3-hide-medium" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Learn Google Sheets</a></p>
</div>
<hr>

<h2>Examples in Each Chapter</h2>
<p>We use practical examples to give the user a better understanding of the concepts.</p>
<hr>

<h2>Copy Values Tool</h2>
<p>Example values can be copied from the tutorial and into your spreadsheet, making it easy for you to tag along step-by-step:</p>

<div class="w3-example">
  <div class="w3-code notranslate">
    <img src="img_google_sheets_index_1.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%">
    <textarea id="demo_google_sheets_index_1" style="display:none">
      309	39
      320	35
      318	45
      314	44
  ...
  <a class="w3-btn w3-margin-bottom" href="javascript:void(0);" onclick="copyFormulas('demo_google_sheets_index_1')">Copy Values</a>
</div>
<hr>

<h2>Why Study Google Sheets?</h2>
<p>Google Sheets is an widely used spreadsheet program.</p>
...
<div>
  ...
  <h2>Test Yourself With Exercises</h2>
    <div class="exercisewindow">
      <h2>Google Sheets Exercise:</h2>
      <p>Complete the Google Sheets formula:</p>
...
<script>
  function copyFormulas(elementId){
    ...
    .then(() => { alert('Range copied to clipboard.\nIt can now be pasted into the Google Sheets spreadsheet.') })
